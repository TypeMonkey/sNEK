 ...
 *
 */
public interface CopperHeadConstants {
     ...
     * A token identity constant.
     */
    public static final int TRUE = 1004;

    /**
     * A token identity constant.
     */
    public static final int FALSE = 1005;

    /**
     * A token identity constant.
     */
    public static final int WHILE = 1006;
     ...
     * A token identity constant.
     */
    public static final int INT = 1008;

    /**
     * A token identity constant.
     */
    public static final int STR = 1009;

    /**
     * A token identity constant.
     */
    public static final int BOOL = 1010;

    /**
     * A token identity constant.
     */
    public static final int LET = 1011;
     ...
     * A token identity constant.
     */
    public static final int SET = 1013;
     ...
     * A production node identity constant.
     */
    public static final int FUNC_DEF = 2003;

    /**
     * A production node identity constant.
     */
    public static final int LET_DEC = 2004;

    /**
     * A production node identity constant.
     */
    public static final int IF_EXPR = 2005;

    /**
     * A production node identity constant.
     */
    public static final int BIN_OP = 2006;

    /**
     * A production node identity constant.
     */
    public static final int SET_VAR = 2007;

    /**
     * A production node identity constant.
     */
    public static final int FUNC_CALL = 2008;

    /**
     * A production node identity constant.
     */
    public static final int WHILE_LOOP = 2009;

    /**
     * A production node identity constant.
     */
    public static final int TYPE = 2010;

    /**
     * A production node identity constant.
     */
    public static final int ATOM = 2011;
}
